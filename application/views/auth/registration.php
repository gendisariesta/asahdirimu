<div class="container">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
        <div class="card-body p-0">
            ...
            <div class="row">
                <div class="col-lg-5 d-none d-lg-block image-login"><img src="<?= base_url('assets/login/img/login2.jpeg') ?>" width="400" background-position: center; background-size: cover></div>
                <div class="col-lg-7">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Mari bergabung dan kembangkan dirimu bersama <strong>#asahdirimu</strong></h1>
                        </div>
